...
STRINGS = {
    ...
    "near_me_caption": (
        "ఫోన్ GPS తరచుగా ±300–2000 మీ తప్పు చూపిస్తుంది. "
        "నమ్మకమైన మార్గం: కింది **పొలం మ్యాప్**‌లో మీ మొక్కను నొక్కండి, "
        "లేదా మొక్క సంఖ్య టైప్ చేయండి. "
        "GPS ఐచ్ఛికం — పొలం దగ్గర (±400 మీ) మరియు ±40 మీ లోపల ఖచ్చితత్వం ఉంటేనే వాడతాం."
    ),
    "near_me_map_help": "మ్యాప్‌లో మీ మొక్క మార్కర్‌పై నొక్కండి → సంఖ్య పెద్దగా కనిపిస్తుంది.",
    "enter_plant_number": "మొక్క సంఖ్య నమోదు చేయండి",
    "show_plant": "మొక్క చూపించు",
    "invalid_plant_number": "చెల్లని మొక్క సంఖ్య (1–%d లోపల ఉండాలి).",
    "gps_optional": "GPS (ఐచ్ఛికం — తరచుగా అస్పష్టం)",
    "gps_ignored_far": (
        "GPS పొలం నుండి %.0f మీ దూరం / అస్పష్టం — నిర్ధారణకు మ్యాప్‌పై మొక్కను నొక్కండి."
    ),
    "selected_via_map": "మ్యాప్ నుండి ఎంచుకున్నారు",
    "selected_via_number": "సంఖ్య నుండి ఎంచుకున్నారు",
    "selected_via_gps": "GPS నుండి సరిపోలింది",
    "near_me_no_plants": (
    ...
    "gps_accuracy_poor": (
        "GPS ఖచ్చితత్వం ఇంకా ±%.0f మీ (మొక్క గుర్తింపుకు ±40 మీ లోపల కావాలి). "
        "మ్యాప్‌పై మొక్కను నొక్కండి లేదా సంఖ్య టైప్ చేయండి — లేదా బయట మళ్లీ "
        "**ఖచ్చితమైన GPS తీసుకోండి** నొక్కి మెరుగైన లాక్ కోసం వేచి ఉండండి."
    ),
